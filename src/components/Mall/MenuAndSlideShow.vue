    ...
    <div class="container">
        <div class="menu-slide">
            <div class ="menu-container">
                <ul class="menu-list">
                    <li class="menu-item" v-for="(item,index) in menus" :key="index" @mouseenter="bannerMenuShow(item.type)">
        ...
        <!-- 用于将鼠标放在上面，物品信息显示的页面 -->
            <div class="menu-info" v-show="MenuFlag" @mouseleave="bannerMenuHide()" @mouseenter="bannerMenuShow()">
                <ul class="info-list" v-for="(list,key) in menuListMatch" :key="key">
...
<script>
import SlideShow from '../../parts/SlideShow.vue';
export default {
    name: 'MenuAndSlideShow',
    data() {
        return {
            MenuFlag:false,
            listInfoData:[],
            ...
            menus: [
                ...
                { value: '家电', url: 'https://www.mi.com/p/9285.html', type: 'household' },
            ...
            slides: [
                { src: 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/f4503c65cc17fdc6cdde806d9ec1bef2.jpg?w=2452&h=920', url: 'https://www.mi.com/redminote7/' },
                { src: 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/b90887bdc163c5f3d067531afff1209a.jpg?thumb=1&w=1839&h=690&f=webp&q=90', url: 'https://www.mi.com/a/h/11251.html' },
            ],
            phone: [
                {name:'Redmi Note 8 Pro', src: 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/e99f7f32923b2ef482338c08544000bb.png', url: 'https://www.mi.com/redminote8pro'},
                {name:'Redmi Note 8', src: 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/c20f8ee8bfff9b12c2c13f6b55a77abb.png', url: 'https://www.mi.com/redminote8'},
    ...
    computed:{
        menuListMatch(){
            if(this.listInfoData&&this.listInfoData.length){
                const matchData = [];
                matchData.push(this.listInfoData.slice(0,0 + this.listInfoData.length));
                return matchData;
            }
        }
    }
